ARG WEBSOCKIFY_MODULE_COMMIT="92179c56d465c176f7651e165a786b4740b71bcb"
...
WORKDIR /tmp/websockify-nginx-module
RUN git checkout ${WEBSOCKIFY_MODULE_COMMIT}
...
COPY --from=cloner /tmp/websockify-nginx-module /tmp/websockify-nginx-module
